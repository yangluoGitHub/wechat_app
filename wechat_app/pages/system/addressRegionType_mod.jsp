...
<form name="form1" method="post" action="addressRegionType.do?action=mod">
<table width="650" align="center" border="0" cellspacing="1" cellpadding="6" class="table1">
 <tr class="tr1">
    <td nowrap colspan="2" align="center"><%=resource.srcStr("修改区域信息")%></td>
  </tr> 
  <tr class="tr3">
    <td nowrap>区域编号：</td>
    <td><input type="hidden" name="districtNo" id="districtNo" value="${addressRegionType.no}">
        <c:out value="${addressRegionType.no}"></c:out>
    </td>
  </tr> 
  <tr class="tr3">
    <td nowrap>区域名称：</td>
    <td><input type="text" name="districtName" id="districtName" value="${addressRegionType.name}" maxlength="20"/>&nbsp;*</td>
  </tr>
 </table>
 <p align="center">
