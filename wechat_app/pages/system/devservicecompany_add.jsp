...
<form name="form1" method="post" action="devSrvCom.do?action=add">
<table id="infoTable" align="center" width="650" border="0" cellspacing="1" cellpadding="5" class="table1" >
 <tr class="tr1">
    <td nowrap colspan="2" align="center"><%=resource.srcStr("System.add_dev_maintainer")%></td>
  </tr>  
  <tr class="tr3">
  ...
  <tr class="tr3">
    ...
    <td nowrap><input type="text" name="linkman"  maxlength="30"></td> 
  </tr>
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("System.address")%>：</td>
    <td nowrap><input type="text" name="address"  style="width:300px;" maxlength="80"></td> 
  </tr>
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("System.fixed")%>1：</td>
    <td nowrap><input type="text" name="phone1" class="phone"></td> 
  </tr>
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("System.fixed")%>2：</td>
    <td nowrap><input type="text" name="phone2" class="phone" ></td> 
  </tr>
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("System.mobile_phone")%>1：</td>
    <td nowrap><input type="text" name="mobile1" class="mobile"></td> 
  </tr>
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("System.mobile_phone")%>2：</td>
    <td nowrap><input type="text" name="mobile2" class="mobile"></td> 
  </tr>
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("System.fax")%>：</td>
    <td nowrap><input type="text" name="fax" class="fax" ></td> 
  </tr>
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("System.email")%>：</td>
    <td nowrap><input type="text" name="email"  maxlength="40"></td> 
  </tr>
</table>
