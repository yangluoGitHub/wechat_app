...
<form name="form1" method="post" action="devcatalog.do?action=add">


<table align="center" width="650" border="0" cellspacing="1" cellpadding="5" class="table1">
 <tr class="tr1">
    <td nowrap colspan="2" align="center"><%=resource.srcStr("System.add_dev_type") %></td>
  </tr>  
  <tr class="tr3">
    <td nowrap><%=resource.srcStr("Main.dev_type") %>：</td>
    <td nowrap><input type="text" name="name" class="pane" onblur="checktext($(name),10);">&nbsp;*</td> 
  </tr>
  <tr class="tr3">
    <td nowrap width="150"><%=resource.srcStr("System.description") %>：</td>
    <td nowrap><input type="text" name="enname" class="pane" onblur="checktext($(enname),30);">&nbsp;</td> 
  </tr> 
</table>
