...
function switchWechatID() {
	...
	userService.qrySwitchableUserPubAccount('${userSession.account}', '${userSession.wechatId}', function(data) {
		if(data == null || data.length == 0) {
			...
			var optionHtml = "";
			var selectStart = "<div style='font-size:15px;padding:180px;'><b>请选择要切换的公众号：</b><select id='userpa' name='userpa'>";
			var selectEnd = "</select>";
			var buttonHtml = "&nbsp;<input type='button' id='ok' value='确定'>&nbsp;" + 
...
<div id="header">
  ...
  <ul>
  	<A href="#" onclick="javascript:switchWechatID();">
  		<img alt="切换公众号管理" title="切换公众号管理" src="../images/title/switch.png" border="0" style="cursor: hand;  z-index:3;" onmouseover="javascript:src='../images/title/switch_1.png'" onmouseout="javascript:src='../images/title/switch.png'">
  	</A>
