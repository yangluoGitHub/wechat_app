...
<table width="100%" style="border:0px;border-bottom:1px solid #cccccc;">
  <tr> 
    <td nowrap><b>菜单管理：</b></td> 
    <td nowrap align="right">
       <input class="button" type="button" value='添加菜单项' onclick="javascript:window.location='wemenu.do?action=addPage'" style="width:110px;">&nbsp;
    </td>
  </tr>
</table>
<br>
