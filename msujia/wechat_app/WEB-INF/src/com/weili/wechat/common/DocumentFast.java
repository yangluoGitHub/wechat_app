...
public class DocumentFast {
	...
	public DocumentFast(String xml) {
		this.xml = xml;
...
//					System.out.println(aBuf[2]&0xFF);//120
	 ...
	 * @return
	 */
	public boolean qryAndCheckFastNodeExist(String path){
		return this.getFastDom().get(path)==null?false:true;
	}
