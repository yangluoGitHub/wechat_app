...
%>
						...
						<table align="center" width="650" border="0" cellspacing="1" cellpadding="5" class="table1">
						  ...
						  <tr class="tr3">
						    <td nowrap><%=resource.srcStr("System.maintainer_name") %>：</td>
						    <td nowrap><input type="text" name="name" class="paneGray" value='<c:out value="${objectvo.name}"/>' readonly>&nbsp;</td> 
						  </tr>
						  <%request.setAttribute("delete_maintainer", resource.srcStr("System.delete_maintainer")); %>
						  <c:if test='${title!=delete_maintainer}'>
						  <tr class="tr3">
						    <td nowrap><%=resource.srcStr("System.address") %>：</td>
						    <td nowrap><input type="text" name="address" class="paneGray" style="width:500px;" value='<c:out value="${objectvo.address}"/> 'readonly>&nbsp;</td> 
						  </tr>
						  <tr class="tr3">
						    <td nowrap><%=resource.srcStr("System.contact") %>：</td>
						    <td nowrap><input type="text" name="linkman" class="paneGray" readonly value='<c:out value="${objectvo.linkMan}"/>' >&nbsp;</td> 
						  </tr>
						  <tr class="tr3">
						    <td nowrap><%=resource.srcStr("System.phone") %>：</td>
						  ...
						  <tr class="tr3">
						    <td nowrap><%=resource.srcStr("System.fax_num") %>：</td>
						    <td nowrap><input type="text" name="fax" class="paneGray" readonly value='<c:out value="${objectvo.fax}"/>'>&nbsp;</td> 
						  </tr>
						  <tr class="tr3">
