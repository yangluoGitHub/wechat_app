...
<br>
<form name="form" method="post" action="param.do?action=addSysparam">
	<table align="center" width="650" border="0" cellspacing="1" cellpadding="5" class="table1">
		<tr class="tr1">
		    <td nowrap colspan="2" align="center">添加系统参数信息</td>
		</tr>
		<tr class="tr3">
			...
			<td>
				<select id="catalog" name="catalog">
		  			...
		  			<c:forEach items="${sysParamCatalogList}" var="sysParamCatalog">
		  				<option value="${sysParamCatalog.catalog }">${sysParamCatalog.catalogName }</option>
		  			</c:forEach>
		  		</select>&nbsp;*
			</td>
		</tr>
		<tr class="tr3">
			...
			<td>
				<input type="text" name="paramName" id="paramName" style="width:200px;" onkeyup="value=value.replace(/[^\w]/g,'')">&nbsp;*(只能由字母、数字或下划线组成)
			</td>
		</tr>
     	<tr class="tr3">
			<td align="right">参数值：</td>
			<td >
				<input type="text" name="paramValue" id="paramValue" style="width:200px;" onkeyup="value=value.replace(/[^\w]/g,'')">&nbsp;(只能由字母、数字或下划线组成)
			</td>
		</tr>
		<tr class="tr3">
			<td align="right">参数说明：</td>
			<td >
				<input type="text" name="statement" id="statement" style="width:200px;">&nbsp;
			</td>
		</tr>
		<tr class="tr3">
