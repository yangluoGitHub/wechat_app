...
public final class error404_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 Resource resource = (Resource)GetResource.getOneResource(application,session.getAttribute("locale").toString());
      ...
      out.write("<br><br><br>\r\n");
      out.write("\r\n");
      out.write("<table align=\"center\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" style=\"border:2px ridge #ff0000;\">\r\n");
      out.write("<tr>\r\n");
      out.write("<td align=\"center\" width=\"400\" height=\"120\" style=\"word-break: break-all;\">\r\n");
      out.print(resource.srcStr("Login.page_no_exists") );
      out.write("\r\n");
      out.write("</td>\r\n");
      out.write("</tr>\r\n");
      out.write("</table>\r\n");
